  ...
  */
  head: {
    ...
    meta: [
      ...
      {hid: 'og:image', property: 'og:image', content: 'https://ik.imagekit.io/alexborecky/CzechCon/og_Ur0luZq29.png' + ogImage}
    ],
    link: [
      { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico' },
      { href: "https://fonts.googleapis.com/css2?family=Red+Hat+Text:wght@400;500;700&display=swap", rel:"stylesheet"},
      { href: "https://fonts.googleapis.com/css2?family=Playfair+Display:wght@600;700&display=swap", rel: "stylesheet" }
    ]
  },
  /*
